/**
 *   Tests for the db collection enhancement via core/db/dbcollection.js
 */

db = connect( "test" )

/*
 *  be sure that the enchancers require the db is passed to it
 */
 
 try {
     core.core.db.dbcollection();
     assert(false);
 }
 catch(e) { 
     //
