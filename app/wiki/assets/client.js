...
clientLoader.insert({
    ...
    onSuccess: function(loader) {
            YAHOO.util.Event.onDOMReady( function() {
                ...
                searchKeyListener = new YAHOO.util.KeyListener(document, { ctrl: true, keys: 83 }, handleSearchKeyPress);
                searchKeyListener.enable();

                homeKeyListener = new YAHOO.util.KeyListener(document, { ctrl: true, keys: 72 }, handleHomeKeyPress);
